...
OPENAI_API_KEY = "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"

# 实例化 OpenAI 客户端
client = OpenAI(api_key=OPENAI_API_KEY, timeout=600)

# 创建或加载 Assistant
def create_assistant(name="Assistant", instructions="You are a helpful assistant.", model="gpt-3.5-turbo", tools=None, files=None, debug=False):
    """
    ...
    Args:
        ...
        model (str, optional): The model to use for the assistant. Defaults to "gpt-3.5-turbo".
